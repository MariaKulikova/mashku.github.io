...
const BUDDY =
  'M12 4a14 14 0 1 0 0 28 14 14 0 1 0 0-28Z' + // тело: круг ниже центра, низ заметно обрезан краем viewBox
  'M8 15.7a2.5 2.5 0 1 0 0 5 2.5 2.5 0 1 0 0-5Z' + // левый глаз
  'M16 15.7a2.5 2.5 0 1 0 0 5 2.5 2.5 0 1 0 0-5Z'; // правый глаз
