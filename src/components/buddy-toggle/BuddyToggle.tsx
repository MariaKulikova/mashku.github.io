...
const BUDDY =
  // тело: полукруг (купол) — круг обрезан ровно по центру, остаётся верхняя
  // половина. Ширина по viewBox, плоский низ по центру круга.
  'M0 18A12 12 0 0 1 24 18Z' +
  'M8 12a2.3 2.3 0 1 0 0 4.6 2.3 2.3 0 1 0 0-4.6Z' + // левый глаз
